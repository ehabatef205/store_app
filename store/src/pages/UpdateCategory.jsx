                    ...
                    <table>
                        ...
                        <tbody>
                            {products.map((product, index) => (
                                <TrTable key={index} index={index + 1} id={product._id} category_id={category_id} name={product.name} quantity={product.quantity} SKU={product.SKU} price={product.price}/>
                            ))}
                        </tbody>
                    </table>
                </div>
